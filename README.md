...
│  │                                │  │    │  │                                │  │
│  │  ┏━━━━━━━━━━━━━━━━━━━━┓        │  │    │  │  ┏━━━━━━━━━━━━━━━━━━━━━━━━┓   │  │
│  │  ┃ Source EC2         ┃        │  │    │  │  ┃ Replication Server     ┃   │  │
│  │  ┃ - nginx            ┃  TCP 1500 │====┼══┼>┃ - 복제 데이터 수신     ┃   │  │
│  │  ┃ - DRS Agent ───────╂─(peering)─┤    │  │  ┃ - Staging EBS 기록     ┃   │  │
│  │  ┃ - IAM Role         ┃        │  │    │  │  ┃ - SG: staging         ┃   │  │
│  │  ┗━━━━━━━━━━━━━━━━━━━━┛        │  │    │  │  ┗━━━━━━━━━━━━━━━━━━━━━━━━┛   │  │
│  │         │                      │  │    │  │         │                      │  │
│  └─────────┼──────────────────────┘  │    │  │  VPC Endpoints:               │  │
│            │ HTTPS 443               │    │  │  ├─ S3 (Gateway)              │  │
│            │ (Internet → DRS API)    │    │  │  ├─ DRS (Interface)           │  │
│            ▼                         │    │  │  └─ EC2 (Interface)           │  │
│  ┌─────────────────┐                │    │  │         │                      │  │
...
└──────────────────────────────────────┘    │  ┌────────────────────────────────┐  │
     ...
     ┌─────────────────────────────┐        │  │                                │  │
     │       VPC Peering           │        │  │  ┏━━━━━━━━━━━━━━━━━━━━┓        │  │
     │  (VPN/DirectConnect 대안)   │        │  │  ┃ Recovery Instance  ┃        │  │
     │  10.100.0.0/16 ↔ 10.200.0.0/16      │  │  ┃ (DR 시에만 시작)   ┃        │  │
     └─────────────────────────────┘        │  │  ┃ - nginx (복제됨)   ┃        │  │
                                            │  │  ┃ - SG: recovery     ┃        │  │
                                            │  │  ┗━━━━━━━━━━━━━━━━━━━━┛        │  │
                                            │  │                                │  │
